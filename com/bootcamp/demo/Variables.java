 ...
 *  5. Packages
 *
 *  Variable is a container of the program CourseManager value in a system memory.
 *
 *  Types of Variables
 *   1. Non-static/ Instance fields - It belongs to the object (instence of the class).
 *                                    That means the field's value can't be shared among
 *                                    the instances of same class
 *    Ex: Class A,
 *      Has variable x
 *      Instances m, n, o
 ...
 *      Has variable x
 *      Instances m, n, o
 *      The value of 'x' is same in all three instances. It sould be declared as static
 *
 *     3. Local variables - It is defined inside the method. Accessed only by the method.
 *
 *     4. Parameters - It is a variable that passed to method as an argument from the caller
 *
 *     5. Final Fields - It is final. The value can't be changed. Mostly used to define the constants.
 *
 *
 ...
 *
 *          Note that the non-object primitive version CourseManager type begins with lower case (long),
...
public class Variables {
    ...
    public static void main(String[] args) {
        // Declaration of primitive CourseManager type - non-object
